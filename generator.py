import numpy as np 
def seq_generator(movie:np.array,running:np.array,trace:list,p,bsize:int,delay:int,eye:np.ndarray,shuffle = True,affine=False):
    ...
    affine : including affine transformation into the model and hence eyetracking data 
    ...
    if affine:             
        while True: 
            ...
            for s in p: 
                ...
                e = eye[get_idx].reshape((bsize,delay,4))
